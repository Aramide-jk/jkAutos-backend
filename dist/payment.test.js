...
describe("Payment Routes", () => {
    ...
    describe("GET /api/payment/paystack/callback", () => {
        it("should verify payment and update purchase status to paid", async () => {
            var _a;
            const reference = (_a = purchase === null || purchase === void 0 ? void 0 : purchase._id) === null || _a === void 0 ? void 0 : _a.toString();
            ...
            expect(updatedPurchase === null || updatedPurchase === void 0 ? void 0 : updatedPurchase.status).toBe("paid");
            expect(updatedPurchase === null || updatedPurchase === void 0 ? void 0 : updatedPurchase.paymentReference).toBe(reference);
        });
